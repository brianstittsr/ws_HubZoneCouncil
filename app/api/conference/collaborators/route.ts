...
export async function GET(req: NextRequest) {
  try {
    ...
    const col = collection(db, COLLECTIONS.CONFERENCE_COLLABORATORS);
    ...
    console.error("GET /api/conference/collaborators:", error);
...
export async function POST(req: NextRequest) {
  try {
    ...
    const docRef = await addDoc(collection(db, COLLECTIONS.CONFERENCE_COLLABORATORS), {
      ...body,
    ...
    console.error("POST /api/conference/collaborators:", error);
