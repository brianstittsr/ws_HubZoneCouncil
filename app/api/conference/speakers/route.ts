...
export async function GET(req: NextRequest) {
  try {
    ...
    const col = collection(db, COLLECTIONS.CONFERENCE_SPEAKERS);
    ...
    console.error("GET /api/conference/speakers:", error);
...
export async function POST(req: NextRequest) {
  try {
    ...
    const docRef = await addDoc(collection(db, COLLECTIONS.CONFERENCE_SPEAKERS), {
      ...body,
    ...
    console.error("POST /api/conference/speakers:", error);
