...
export async function POST(
  ...
  try {
    ...
    const meeting = meetingDoc.data() as FirefliesMeetingDoc;
...
Return ONLY valid JSON array, no other text.`;
    ...
    // Convert to FirefliesActionItem format
    const newActionItems: FirefliesActionItem[] = newTasks.map((task, index) => ({
