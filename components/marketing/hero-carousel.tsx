...
const defaultSlides: HeroSlide[] = [
  {
    id: "1",
    badge: "HUBZone Contracting Success",
    headline: "Navigate federal contracting.",
    highlightedText: "Grow Your Business.",
    subheadline: "We help HUBZone businesses navigate federal contracting, connect with prime contractors, and win government contracts through education and advocacy.",
    benefits: ["Education & Training", "Prime Connections", "Certification Support"],
    primaryCta: { text: "Get Started", href: "/contact" },
    secondaryCta: { text: "Learn More", href: "/about" },
    isPublished: true,
    order: 1,
    backgroundImage: "https://images.pexels.com/photos/891059/pexels-photo-891059.jpeg?auto=compress&cs=tinysrgb&w=1920&q=80",
  },
  {
    id: "2",
    badge: "HUBZone Programs",
    headline: "Grow your business.",
    highlightedText: "Win Federal Contracts.",
    subheadline: "HubZone Council helps businesses navigate federal contracting with education, certification support, and connections to prime contractors and agencies.",
    benefits: ["Education & Training", "Certification Support", "Prime Connections"],
